	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<div class = "alert alert-info">Comptes / Modifier le Compte</div>
				<?php
					$query = $conn->query("SELECT * FROM `utilisateur` WHERE `admin_id` = '$_REQUEST[admin_id]'") or die(mysqli_error());
